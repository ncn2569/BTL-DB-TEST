...
(1010, 55000, N'Bún bò Huế đặc biệt', N'Bún bò Huế chuẩn vị, nhiều thịt', N'còn hàng', 'bunbohue.jpg', 4.8),
(1011, 65000, N'Lẩu thái mini', N'Lẩu thái chua cay cho 1 người', N'còn hàng', 'lauthai.jpg', 4.5),
(1012, 12000, N'Nước lọc đóng chai', N'Nước tinh khiết', N'còn hàng', 'nuocloc.jpg', 4.1),
(1013, 32000, N'Bánh mì gà xé', N'Bánh mì giòn, gà xé thơm ngon', N'còn hàng', 'banhmi_ga.jpg', 4.3),
(1014, 28000, N'Cà phê đen đá', N'Cà phê nguyên chất, pha phin', N'còn hàng', 'cf_den.jpg', 4.7),
(1015, 75000, N'Sushi cuộn cá hồi', N'Set sushi 8 miếng cá hồi tươi', N'còn hàng', 'sushi_ca.jpg', 4.9),
(1016, 50000, N'Bánh pizza chay', N'Pizza rau củ cho người ăn chay', N'hết hàng', 'pizza_chay.jpg', 4.0),
(1017, 18000, N'Sinh tố bơ', N'Bơ tươi, sữa đặc', N'còn hàng', 'sinhto_bo.jpg', 4.4),
(1018, 38000, N'Kem ốc quế', N'Kem vanilla ốc quế lớn', N'còn hàng', 'kem_ocque.jpg', 4.6),
(1019, 42000, N'Gà viên chiên xù', N'Gà viên tẩm bột giòn', N'còn hàng', 'ga_vien.jpg', 4.2),
(1020, 58000, N'Mì Ý hải sản', N'Mì Ý sốt cà chua, tôm mực', N'còn hàng', 'mi_y_hai.jpg', 4.5),
(1021, 22000, N'Bánh tiêu', N'Bánh tiêu chiên nóng', N'còn hàng', 'banh_tieu.jpg', 3.8),
(1022, 19000, N'Trà đào cam sả', N'Trà trái cây mát lạnh', N'còn hàng', 'tradao.jpg', 4.3),
(1023, 70000, N'Set gà rán 2 người', N'2 miếng gà, khoai tây, nước', N'còn hàng', 'set_ga.jpg', 4.7),
(1024, 26000, N'Xôi xéo', N'Xôi đậu xanh, hành phi, ruốc', N'còn hàng', 'xoi_xeo.jpg', 4.1),
(1025, 48000, N'Bún riêu cua', N'Bún riêu cua đồng, chả', N'còn hàng', 'bun_rieu.jpg', 4.6),
(1026, 85000, N'Combo Burger bò', N'Burger bò lớn, khoai tây chiên', N'còn hàng', 'burger_bo.jpg', 4.9),
(1027, 23000, N'Sữa chua nếp cẩm', N'Sữa chua lên men, nếp cẩm', N'còn hàng', 'suachua.jpg', 4.0),
(1028, 33000, N'Bánh bao nhân thịt', N'Bánh bao hấp nóng', N'còn hàng', 'banh_bao.jpg', 4.2),
(1029, 62000, N'Cơm sườn bì chả', N'Cơm tấm sườn, bì, chả', N'còn hàng', 'com_suon.jpg', 4.5),
(1030, 20000, N'Khoai tây chiên', N'Khoai tây cắt lát chiên giòn', N'còn hàng', 'khoai_tay.jpg', 4.1),
(1031, 36000, N'Chè thập cẩm', N'Chè nhiều loại hạt', N'còn hàng', 'che_thap.jpg', 4.3),
(1032, 95000, N'Bánh kem nhỏ', N'Bánh kem size 10cm', N'còn hàng', 'banh_kem.jpg', 4.8),
(1033, 49000, N'Món gỏi cuốn tôm thịt', N'Gỏi cuốn tươi mát', N'hết hàng', 'goi_cuon.jpg', 4.4),
(1034, 15000, N'Sữa đậu nành', N'Sữa đậu nành tươi', N'còn hàng', 'sua_dau.jpg', 4.0),
(1035, 80000, N'Thịt nướng xiên', N'Thịt heo nướng xiên kiểu Hàn', N'còn hàng', 'thit_nuong.jpg', 4.7),
(1036, 55000, N'Phở gà', N'Phở gà ta, nước dùng ngọt', N'còn hàng', 'pho_ga.jpg', 4.5),
(1037, 29000, N'Trứng chiên', N'Trứng chiên hành', N'còn hàng', 'trung_chien.jpg', 3.9),
(1038, 38000, N'Nước dừa tươi', N'Dừa xiêm Bến Tre', N'còn hàng', 'nuoc_dua.jpg', 4.6),
(1039, 44000, N'Bánh crepe sầu riêng', N'Bánh crepe nhân sầu riêng', N'còn hàng', 'crepe.jpg', 4.8),
(1040, 110000, N'Lẩu mắm', N'Lẩu mắm miền Tây', N'còn hàng', 'lau_mam.jpg', 4.3),
(1041, 19000, N'Sinh tố mãng cầu', N'Mãng cầu tươi, sữa chua', N'hết hàng', 'sinhto_man.jpg', 4.1),
(1042, 68000, N'Hambuger Double Cheese', N'Burger bò hai lớp phô mai', N'còn hàng', 'burger_doi.jpg', 4.9),
(1043, 31000, N'Bánh chuối', N'Bánh chuối nướng', N'còn hàng', 'banh_chuoi.jpg', 4.2),
(1044, 45000, N'Gà bó xôi', N'Gà nguyên con bó xôi chiên', N'còn hàng', 'ga_boxoi.jpg', 4.7),
(1045, 14000, N'Bia Sài Gòn', N'Bia chai Sài Gòn Lager', N'còn hàng', 'bia.jpg', 3.5),
(1046, 52000, N'Cơm chiên hải sản', N'Cơm chiên tôm, mực', N'còn hàng', 'com_chien.jpg', 4.6),
(1047, 99000, N'Bò lúc lắc', N'Thịt bò lúc lắc rau củ', N'còn hàng', 'bo_luc.jpg', 4.8),
(1048, 27000, N'Rau câu dừa', N'Rau câu làm từ nước dừa', N'còn hàng', 'raucau.jpg', 4.1),
(1049, 39000, N'Bánh khoai mì', N'Bánh khoai mì nướng', N'còn hàng', 'banh_khoaimi.jpg', 4.3);
